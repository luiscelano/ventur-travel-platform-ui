    ...
    <>
      <Contenido>
        <Section1>
          ...
          <Typography Typography type="paragraph2">
            Creación de usuario
          </Typography>
          <Field size="large" color="background1" placeholder="Usuario"></Field>
          <Field size="large" color="background2" placeholder="Nombre"></Field>
          <Field size="large" color="background1" placeholder="Apellido"></Field>
